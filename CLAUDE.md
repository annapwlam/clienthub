...
ClientHub is a sales and management platform for tracking leads, follow-ups, conversions, and business performance metrics in one unified workspace.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "194445514+annapwlam@users.noreply.github.com"
  git config user.name "annapwlam"
  ```
